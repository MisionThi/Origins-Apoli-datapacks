...
# Copies over the items from the shulker to the players enderchest
item replace entity @s enderchest.0 from block 0 -64 0 container.0
...
item replace entity @s enderchest.8 from block 0 -64 0 container.8
...
item replace entity @s enderchest.18 from block 0 -64 0 container.18
item replace entity @s enderchest.19 from block 0 -64 0 container.19
...
item replace entity @s enderchest.25 from block 0 -64 0 container.25
item replace entity @s enderchest.26 from block 0 -64 0 container.26
