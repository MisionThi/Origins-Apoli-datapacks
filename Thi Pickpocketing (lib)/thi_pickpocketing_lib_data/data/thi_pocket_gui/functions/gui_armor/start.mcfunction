...
execute unless score @s thi_gui_screen_old = @s thi_gui_screen run function thi_pocket_main:api/page_change/open_page {page:3}
...
execute if score @s thi_gui_screen matches 3 run function thi_pocket_gui:gui_armor/interactions/actor/check_item_changed

## Reset/set gui
execute if score @s thi_gui_screen matches 3 run function thi_pocket_gui:gui_armor/mask

# Setup for page transfer
execute unless score @s thi_gui_screen matches 3 run function thi_pocket_main:api/page_change/close_page {page:3}
