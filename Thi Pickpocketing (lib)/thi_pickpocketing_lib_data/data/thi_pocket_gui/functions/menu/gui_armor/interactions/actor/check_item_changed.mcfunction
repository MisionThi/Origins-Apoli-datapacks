...
data modify storage thi_endergui:storage Temp.loop.slots set value [10,12,14,16]
function thi_pocket_main:items_changed/main

# Trigger something based on results
function thi_pocket_gui:menu/gui_armor/interactions/actor/edit_slots with storage thi_endergui:storage Temp
