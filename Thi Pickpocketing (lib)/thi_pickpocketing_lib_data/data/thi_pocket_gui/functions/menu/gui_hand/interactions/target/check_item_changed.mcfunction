...
function thi_pocket_gui:menu/gui_hand/interactions/target/call_items_changed with storage thi_endergui:storage Temp
...
function thi_pocket_gui:menu/gui_hand/interactions/target/edit_slots with storage thi_endergui:storage Temp
