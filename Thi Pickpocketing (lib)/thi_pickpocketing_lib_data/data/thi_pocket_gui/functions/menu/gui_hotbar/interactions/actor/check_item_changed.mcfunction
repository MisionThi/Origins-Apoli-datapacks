...
data modify storage thi_endergui:storage Temp.loop.slots set value [9,10,11,12,13,14,15,16,17]
function thi_pocket_main:items_changed/main

# Trigger something based on results
function thi_pocket_gui:menu/gui_hotbar/interactions/actor/edit_slots with storage thi_endergui:storage Temp
