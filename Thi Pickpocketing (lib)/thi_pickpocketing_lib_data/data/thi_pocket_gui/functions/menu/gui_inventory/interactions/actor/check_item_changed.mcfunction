...
$execute unless data storage thi_endergui:storage Players[{UUID:$(UUID)}].gui.current[{Slot:0b}] run scoreboard players set .button thi_buttons 3
...
execute if score .button thi_buttons matches 1 run function thi_pocket_gui:menu/gui_inventory/interactions/actor/change_page/mode_2 with storage thi_endergui:storage Temp
...
execute if score .button thi_buttons matches 2 run function thi_pocket_gui:menu/gui_inventory/interactions/actor/change_page/mode_1 with storage thi_endergui:storage Temp
# Back
execute if score .button thi_buttons matches 3 run scoreboard players set @s thi_gui_screen 10
...
function thi_pocket_gui:menu/gui_inventory/interactions/actor/edit_slots with storage thi_endergui:storage Temp
